...
def download_and_load_model(drive_url):
    ...
    if response.status_code == 200:
        ...
        st.error(f"Failed to download model from {drive_url}")
        st.stop()

# --- Your actual Google Drive links ---
DURATION_MODEL_URL = "https://drive.google.com/uc?export=download&id=11zwAbzsmHBeml73FK4RbX-hZ8TikPfgV"
DISTANCE_MODEL_URL = "https://drive.google.com/uc?export=download&id=1nQ5zCE_SiACKcHWxvpkoBkxR_dct10Tw"
FARE_MODEL_URL = "https://drive.google.com/uc?export=download&id=1YKl_P-dEWB3mb_5HyBxkaTleiygZPQDF"

# --- Load models and encoders with a nice spinner ---
